...
if (isset($_POST['launch'])) {
	...
	if ($query) {
		if (!empty($_FILES['slider_img']['name'])) {
			...
			unlink('assets/img/' . $_POST['slider_img_hidden']);
		}
		header('Location:manage-home-slider.php');
	}
}
$row = mysqli_fetch_array(mysqli_query($conn, "select * from tbl_slider where slider_id=$edit_id"));
?>
                                                ...
                                                <div class="card card-flush pt-3 mb-5 mb-lg-10">
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-title">
                                                            <h2 class="fw-bolder">Edit Banner</h2>
                                                        </div>
                                                    ...
                                                    <div class="card-body pt-0">
                                                                ...
                                                                <table id="kt_create_new_custom_fields"
                                                                    ...
                                                                    <thead>
                                                                        <tr
                                                                            ...
                                                                            <th class="pt-0">Slider Pre-Heading</th>
                                                                            <th class="pt-0">Slider Main Heading</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                <input type="text"
                                                                                    ...
                                                                                    name="slider_prehead"
                                                                                    value="<?= $row['slider_prehead'] ?>" />
                                                                            </td>
                                                                            <td>
                                                                                <input type="text"
                                                                                    class="form-control form-control-solid"
                                                                                    name="slider_mainhead"
                                                                                    value="<?= $row['slider_mainhead'] ?>" />
                                                                            </td>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                <input type="file"
                                                                                    class="form-control form-control-solid"
                                                                                    value="" name="slider_img" />
                                                                                <?php if (!empty($row['slider_img'])) { ?>
                                                                                <img src="<?= BASE_URL ?>assets/img/<?= $row['slider_img'] ?>"
                                                                                    width='50' class="mt-3">
                                                                                <?php } ?>
                                                                                <input type="hidden"
                                                                                    name="slider_img_hidden"
                                                                                    value="<?= $row['slider_img'] ?>">
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                    <!--end::Table body-->
                                                        ...
                                                        <button type="submit" name="launch" style="width: 100%;"
                                                            ...
                                                            <span class="indicator-label">Update Slider</span>
                                                            </span>
                                                        </button>
