...
if (isset($_POST['launch'])) {
	...
	$service_banner_img = $_POST['service_banner_img'];
	$service_bottom_img = $_POST['service_bottom_img'];
	$service_slug = $_POST['service_slug'];
	$service_desc = $_POST['service_desc'];
	$is_active = ($_POST['is_active'] != '' ? 1 : 2);

	if (!empty($_FILES['service_banner_img']['name'])) {
		$service_banner_img = 'img_' . rand(0, 1000) . '_' . $_FILES['service_banner_img']['name'];
	} else {
		$service_banner_img = $_POST['banner_img_hidden'];
	}

	if (!empty($_FILES['service_bottom_img']['name'])) {
		$service_bottom_img = 'img_' . rand(0, 1000) . '_' . $_FILES['service_bottom_img']['name'];
	} else {
		$service_bottom_img = $_POST['bottom_img_hidden'];
	}
	$query = mysqli_query($conn, "update tbl_service
    	                                             SET service_name='$service_name',
													 service_banner_img='$service_banner_img',
													 service_bottom_img='$service_bottom_img',
													 service_slug='$service_slug',
													 service_desc='$service_desc',
    	                                             is_active=$is_active where service_id=$edit_id");

	if ($query) {
		if (!empty($_FILES['service_banner_img']['name'])) {
			move_uploaded_file($_FILES['service_banner_img']['tmp_name'], 'assets/img/' . $service_banner_img . '');
			unlink('assets/img/' . $_POST['banner_img_hidden']);
		}
		if (!empty($_FILES['service_bottom_img']['name'])) {
			move_uploaded_file($_FILES['service_bottom_img']['tmp_name'], 'assets/img/' . $service_bottom_img . '');
			unlink('assets/img/' . $_POST['bottom_img_hidden']);
		}
		header('Location:manage-services.php');
	}
}
$details = mysqli_fetch_array(mysqli_query($conn, "select * from tbl_service where service_id=$edit_id"));
?>
							...
							<div id="kt_content_container" class="container-xxl">
								...
								<div class="d-flex flex-column flex-lg-row">
									...
									<div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
										<!--begin::Form-->
										<form class="form" enctype="multipart/form-data" method="post" id="kt_subscriptions_create_new">
											<!--begin::Customer-->
													...
													<div class="card-body pt-0">
															...
															<div class="table-responsive">
																...
																<table id="kt_create_new_custom_fields" class="table align-middle table-row-dashed fw-bold fs-6 gy-5">
																	...
																	<tbody>
																		<tr>
																			<td>
																				<input type="text" class="form-control form-control-solid" name="service_name" value="<?= $details['service_name'] ?>" />
																			</td>
																			<td>
																				<input type="text" class="form-control form-control-solid" name="service_slug" value="<?= $details['service_slug'] ?>" />
																			</td>
																...
																<table id="kt_create_new_custom_fields" class="table align-middle table-row-dashed fw-bold fs-6 gy-5">
																	...
																	<thead>
																		<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
																			<th class="pt-0">Service Banner Image</th>
																			<th class="pt-0">Service Bottom Image</th>
																	...
																	<tbody>
																		<tr>
																			<td>
																				<input type="file" class="form-control form-control-solid" value="" name="service_banner_img" />
																				<?php if (!empty($details['service_banner_img'])) { ?>
																					<img src="<?= BASE_URL ?>assets/img/<?= $details['service_banner_img'] ?>" width='50' class="mt-3">
																				<?php } ?>
																				<input type="hidden" name="banner_img_hidden" value="<?= $details['service_banner_img'] ?>">
																			</td>
																			<td>
																				<input type="file" class="form-control form-control-solid" name="service_bottom_img" />
																				<?php if (!empty($details['service_bottom_img'])) { ?>
																					<img src="<?= BASE_URL ?>assets/img/<?= $details['service_bottom_img'] ?>" width='50' class="mt-3">
																				<?php } ?>
																				<input type="hidden" name="bottom_img_hidden" value="<?= $details['service_bottom_img'] ?>">
																			</td>
																...
																<table id="kt_create_new_custom_fields" class="table align-middle table-row-dashed fw-bold fs-6 gy-5">
																	...
																	<thead>
																		<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
																			<th class="pt-0">Service Description</th>
																		</tr>
																	</thead>
																	<tbody>
																		<tr>
																			<td>
																				...
																				<textarea name="service_desc" id="default"><?= $details['service_desc'] ?></textarea>
																			</td>
														...
														<div class="d-flex flex-stack mb-8">
															<div class="me-5">
																...
																<div class="fs-7 fw-bold text-muted">Active/Inactive</div>
															</div>
															<!--end::Label-->
															<!--begin::Switch-->
														...
														<button type="submit" name="launch" style="width: 100%;" id="kt_modal" class="btn text-center btn-primary">
