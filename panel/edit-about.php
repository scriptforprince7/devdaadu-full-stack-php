...
if (isset($_POST['launch'])) {
	...
	$query = mysqli_query($conn, "update tbl_about
    	                                             SET about_heading='$about_heading',
													 about_desc='$about_desc',
    	                                             is_active=$is_active where about_id=$edit_id");

	if ($query) {
		header('Location:manage-about.php');
	}
}
$details = mysqli_fetch_array(mysqli_query($conn, "select * from tbl_about where about_id=$edit_id"));
?>
                                                ...
                                                <div class="card card-flush pt-3 mb-5 mb-lg-10">
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-title">
                                                            <h2 class="fw-bolder">Edit About</h2>
                                                        </div>
                                                    ...
                                                    <div class="card-body pt-0">
                                                            ...
                                                            <div class="table-responsive">
                                                                ...
                                                                <table id="kt_create_new_custom_fields"
                                                                    ...
                                                                    <thead>
                                                                        <tr
                                                                            ...
                                                                            <th class="pt-0">About Heading</th>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                <textarea name="about_heading"
                                                                                    id="default"><?= $details['about_heading'] ?></textarea>
                                                                            </td>
                                                                ...
                                                                <table id="kt_create_new_custom_fields"
                                                                    ...
                                                                    <thead>
                                                                        <tr
                                                                            class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                                                            <th class="pt-0">About Description</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                <textarea name="about_desc"
                                                                                    id="default"><?= $details['about_desc'] ?></textarea>
                                                                            </td>
                                                        ...
                                                        <button type="submit" name="launch" style="width: 100%;"
                                                            ...
                                                            <span class="indicator-label">Update About</span>
                                                            </span>
                                                        </button>
