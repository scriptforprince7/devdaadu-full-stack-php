...
if (isset($_GET['del'])) {
	$t_id = $_GET['del'];
	$query = mysqli_query($conn, "delete from tbl_about where about_id=$t_id");
	if ($query) {
		header('Location:' . BASE_URL . 'manage-about.php');
	}
}
								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-toolbar">
										...
										<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
											...
											<!--begin::Add customer-->
											<a href="add-about.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add New About</button></a>
											<!--end::Add customer-->
										</div>
										<!--end::Toolbar-->
										<!--begin::Group actions-->
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="min-w-125px">About Heading</th>
												<th class="min-w-125px">About Description</th>
										...
										<tbody class="fw-bold text-gray-600">
											<?php
											$query = mysqli_query($conn, "select * from tbl_about order by about_id asc");
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a href="<?= BASE_URL ?>edit-about.php?edit_rec=<?= $row['about_id'] ?>" class="menu-link px-3"> Edit </a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="<?= BASE_URL ?>manage-about.php?del=<?= $row['about_id'] ?>" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Delete</a>
																</div>
																<!--end::Menu item-->
															</div>
															<!--end::Menu-->
