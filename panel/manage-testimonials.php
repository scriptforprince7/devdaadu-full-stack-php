                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            ...
                                            <!--begin::Add customer-->
                                            <a href="add-testimonials.php"><button type="button" class="btn btn-primary"
                                                    data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add
                                                    New Testimonials</button></a>
                                            <!--end::Add customer-->
                                        </div>
                                        <!--end::Toolbar-->
                                        <!--begin::Group actions-->
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="<?= BASE_URL ?>edit-testimonials.php?edit_rec=<?= $row['testimonials_id'] ?>"
                                                                class="menu-link px-3"> Edit </a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="<?= BASE_URL ?>manage-testimonials.php?del=<?= $row['testimonials_id'] ?>"
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form action="" method="post" id="kt_customers_export_form"
                                                enctype="multipart/form-data" class="form">
                                                <div class="fv-row mb-10">
                                                    <label class="fs-5 fw-bold form-label mb-5">Select Date
                                                        Range:</label>
                                                    <input value="<?= $details['blog_title'] ?>"
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="blog_title"
                                                            value="<?= $details['blog_title'] ?>" class="form-control"
                                                            autocomplete="off" placeholder="Heading">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="blog_content"
                                                            value="<?= $details['blog_content'] ?>" class="form-control"
                                                            autocomplete="off" placeholder="Heading">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleInputPassword1">Main Page Content
                                                            <span class="text-danger">*</span></label>
                                                        <textarea name="main_page_desc" id="editor" cols="30"
                                                            rows="10"><?= $details['main_page_desc'] ?></textarea>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <img src="<?= BASE_URL_IMG ?><?= $details['blog_img'] ?>"
                                                            width='50' class="mt-3">
                                                        <?php } ?>
                                                        <input type="hidden" name="blog_img_hidden"
                                                            value="<?= $details['blog_img'] ?>">
                                                    </div>
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="https://keenthemes.com" target="_blank"
                                class="text-gray-800 text-hover-primary">Dev Daadu</a>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Menu-->
