...
if (isset($_POST['launch'])) {
	...
	$query = mysqli_query($conn, "update tbl_faq
    	                                             SET faq_question='$faq_question',
													 faq_answer='$faq_answer',
    	                                             is_active=$is_active where faq_id=$edit_id");

	if ($query) {
		header('Location:manage-faq.php');
	}
}
$details = mysqli_fetch_array(mysqli_query($conn, "select * from tbl_faq where faq_id=$edit_id"));
?>
                                                ...
                                                <div class="card card-flush pt-3 mb-5 mb-lg-10">
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-title">
                                                            <h2 class="fw-bolder">Edit FAQ's</h2>
                                                        </div>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <textarea name="faq_answer"
                                                                                    id="default"><?= $details['faq_answer'] ?></textarea>
                                                                            </td>
