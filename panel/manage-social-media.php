...
if (isset($_GET['del'])) {
	$t_id = $_GET['del'];
	$query = mysqli_query($conn, "delete from tbl_sm where sm_id=$t_id");
	if ($query) {
		header('Location:' . BASE_URL . 'manage-social-media.php');
	}
}
								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-toolbar">
										...
										<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
											...
											<!--begin::Add customer-->
											<a href="add-social-media.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Social Media link</button></a>
											<!--end::Add customer-->
										</div>
										<!--end::Toolbar-->
										<!--begin::Group actions-->
								...
								<div class="card-body pt-0">
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
										...
										<tbody class="fw-bold text-gray-600">
											<?php
											$query = mysqli_query($conn, "select * from tbl_sm order by sm_id asc");
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a href="<?= BASE_URL ?>edit-social-media.php?edit_rec=<?= $row['sm_id'] ?>" class="menu-link px-3"> Edit </a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="<?= BASE_URL ?>manage-social-media.php?del=<?= $row['sm_id'] ?>" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Delete</a>
																</div>
																<!--end::Menu item-->
															</div>
															<!--end::Menu-->
