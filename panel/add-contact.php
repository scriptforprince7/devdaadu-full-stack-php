								...
								<div class="card">
									...
									<div class="card-body pb-0">
										...
										<div class="card-px text-center pt-20 pb-5">
											<!--begin::Title-->
											<h2 class="fs-2x fw-bolder mb-0">Add New Contact</h2>
											<!--end::Title-->
											<!--begin::Description-->
											<p class="text-gray-400 fs-4 fw-bold py-7">Click on the below button to launch
												<br />a new contact. <a href="manage-contact.php"><b>Go back</b></a>
											</p>
											<!--end::Description-->
											<!--begin::Action-->
											<a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">Add New Contact</a>
											<!--end::Action-->
										</div>
										<!--end::Heading-->
										<!--begin::Illustration-->
											...
											<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
												...
												<form id="kt_modal" class="form" method="post" enctype="multipart/form-data">
													...
													<div class="mb-13 text-center">
														...
														<!--end::Title-->
														<!--begin::Description-->
														<div class="text-muted fw-bold fs-5">To see all contact, please
															check
															<a href="manage-contact.php" class="fw-bolder link-primary">Manage Contact</a>.
														</div>
														<!--end::Description-->
													</div>
													<!--end::Heading-->
													...
													<div class="d-flex flex-column mb-8 fv-row">
														...
														<input type="text" class="form-control form-control-solid" placeholder="Enter Contact Name" name="contact_number" />
													</div>
													<div class="d-flex flex-column mb-8 fv-row">
														<label class="d-flex align-items-center fs-6 fw-bold mb-2">
														...
														<input type="text" class="form-control form-control-solid" placeholder="Enter Contact Name" name="contact_address" />
													</div>
													<div class="d-flex flex-column mb-8 fv-row">
														<label class="d-flex align-items-center fs-6 fw-bold mb-2">
														...
														<input type="text" class="form-control form-control-solid" placeholder="Enter Contact Name" name="contact_email" />
													</div>
													<div class="d-flex flex-column mb-8 fv-row">
														<label class="d-flex align-items-center fs-6 fw-bold mb-2">
															<span class="required">Opening Hour</span>
															<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a target name for future usage and reference"></i>
														</label>
														<input type="text" class="form-control form-control-solid" placeholder="Enter Contact Name" name="contact_openinghour" />
													</div>
