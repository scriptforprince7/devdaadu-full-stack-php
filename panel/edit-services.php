                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <img src="<?= BASE_URL ?>assets/img/<?= $details['service_banner_img'] ?>"
                                                                                    width='50' class="mt-3">
                                                                                <?php } ?>
                                                                                <input type="hidden"
                                                                                    name="banner_img_hidden"
                                                                                    value="<?= $details['service_banner_img'] ?>">
                                                                            </td>
                                                                            <td>
                                                                                <input type="file"
                                                                                    class="form-control form-control-solid"
                                                                                    name="service_bottom_img" />
                                                                                <?php if (!empty($details['service_bottom_img'])) { ?>
                                                                                <img src="<?= BASE_URL ?>assets/img/<?= $details['service_bottom_img'] ?>"
                                                                                    width='50' class="mt-3">
                                                                                <?php } ?>
                                                                                <input type="hidden"
                                                                                    name="bottom_img_hidden"
                                                                                    value="<?= $details['service_bottom_img'] ?>">
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <textarea name="service_desc"
                                                                                    id="default"><?= $details['service_desc'] ?></textarea>
                                                                            </td>
