												...
												<div class="card card-flush pt-3 mb-5 mb-lg-10">
													...
													<div class="card-body pt-0">
															...
															<div class="table-responsive">
																...
																<table id="kt_create_new_custom_fields" class="table align-middle table-row-dashed fw-bold fs-6 gy-5">
																	...
																	<tbody>
																		<tr>
																			<td>
																				<input type="text" class="form-control form-control-solid" id="editor" name="row-name" value="<?= $details['service_desc'] ?>" />
																			</td>
														...
														<div class="d-flex flex-column mb-5 fv-row rounded-3 p-7 border border-dashed border-gray-300">
															<div class="fs-5 fw-bolder form-label mb-3">Status
															</div>
															<label class="form-check form-check-custom form-check-solid">
																<input class="form-check-input" type="checkbox" checked="checked" value="1" />
																<span class="form-check-label text-gray-600">Active or Inactive</span>
															</label>
															<!--end::Checkbox-->
														</div>
