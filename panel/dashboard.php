										...
										<div class="flex-grow-1">
											...
											<div class="d-flex flex-wrap flex-stack" style="flex-direction: row-reverse;">
												...
												<div class="d-flex flex-column flex-grow-1 pe-8">
													<p><i>We are <b>DEV DAADU</b>  INVESTMENT & INSURANCE CONSULTANTS , we make “Investment” a wise choice by efficient “Tax planning” and building a “Portfolio”, which fulfils your financial goals.</i></p>
								...
								<div class="card-body p-9">
									...
									<div class="row mb-7">
										...
										<div class="col-lg-8 fv-row">
											<span class="fw-bold text-gray-800 fs-6">Dev Daadu</span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
									...
									<div class="row mb-7">
										...
										<div class="col-lg-8 d-flex align-items-center">
											<span class="fw-bolder fs-6 text-gray-800 me-2">+91 98965 70700</span>
									...
									<div class="row mb-7">
										...
										<div class="col-lg-8">
											<a href="#" class="fw-bold fs-6 text-gray-800 text-hover-primary">
												Insurance & Investment Consultant</a>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
									...
									<div class="row mb-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="fw-bolder fs-6 text-gray-800">email@example.com, +91 98965 70700</span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
												...
												<table class="table align-middle gs-0 gy-5">
													...
													<tbody>
														<tr>
															...
															<td>
																<a href="#" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">Manage Services Page</a>
																<span class="text-muted fw-bold d-block fs-7">Add/Edit</span>
															</td>
															<td>
														...
														<tr>
															...
															<td>
																<a href="#" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">Manage Products Page</a>
																<span class="text-muted fw-bold d-block fs-7">Add/Edit</span>
															</td>
															<td>
																<div class="d-flex flex-column w-100 me-2">
