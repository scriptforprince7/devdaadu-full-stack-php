...
if (isset($_POST['launch'])) {
	...
	$query = mysqli_query($conn, "insert into tbl_faq
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="card-px text-center pt-20 pb-5">
                                            <!--begin::Title-->
                                            <h2 class="fs-2x fw-bolder mb-0">Add New FAQ</h2>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <p class="text-gray-400 fs-4 fw-bold py-7">Click on the below button to
                                                launch
                                                <br />a new FAQ. <a href="manage-faq.php"><b>Go back</b></a>
                                            </p>
                                            <!--end::Description-->
                                            <!--begin::Action-->
                                            <a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal"
                                                data-bs-target="#kt_modal_new_target">Add New FAQ</a>
                                            <!--end::Action-->
                                        </div>
                                        <!--end::Heading-->
                                        <!--begin::Illustration-->
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                <!--begin:Form-->
                                                <form id="kt_modal" class="form" method="post"
                                                    enctype="multipart/form-data">
                                                    <!--begin::Heading-->
                                                    <div class="mb-13 text-center">
                                                        <!--begin::Title-->
                                                        <h1 class="mb-3">Add New FAQ</h1>
                                                        <!--end::Title-->
                                                        <!--begin::Description-->
                                                        <div class="text-muted fw-bold fs-5">To see all faq, please
                                                            check
                                                            <a href="manage-faq.php"
                                                                class="fw-bolder link-primary">Manage FAQ</a>.
                                                        </div>
                                                        <!--end::Description-->
                                                    </div>
                                                    <!--end::Heading-->
                                                    ...
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid"
                                                            placeholder="Enter FAQ Name" name="faq_question" />
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Input group-->
                                                    <div class="d-flex flex-column mb-8">
                                                        <label class="fs-6 fw-bold mb-2">FAQ Answer</label>
                                                        <textarea class="form-control form-control-solid" id="editor"
                                                            name="faq_answer" placeholder="Type FAQ Content"></textarea>
                                                    </div>
