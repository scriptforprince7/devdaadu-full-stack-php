...
if (isset($_POST['launch'])) {
	...
	$query = mysqli_query($conn, "update tbl_contact
    	                                             SET contact_number='$contact_number',
													 contact_address='$contact_address',
													 contact_email='$contact_email',
													 contact_openinghour='$contact_openinghour',
    	                                             is_active=$is_active where contact_id=$edit_id");

	if ($query) {
		header('Location:manage-contact.php');
	}
}
$details = mysqli_fetch_array(mysqli_query($conn, "select * from tbl_contact where contact_id=$edit_id"));
?>
                                                ...
                                                <div class="card card-flush pt-3 mb-5 mb-lg-10">
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-title">
                                                            <h2 class="fw-bolder">Edit Contact</h2>
                                                        </div>
                                                            ...
                                                            <div class="table-responsive">
                                                                ...
                                                                <table id="kt_create_new_custom_fields"
                                                                    ...
                                                                    <thead>
                                                                        <tr
                                                                            ...
                                                                            <th class="pt-0">Contact Address</th>
                                                                ...
                                                                <table id="kt_create_new_custom_fields"
                                                                    ...
                                                                    <thead>
                                                                        <tr
                                                                            class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                                                            <th class="pt-0">Contact Email</th>
                                                                            <th class="pt-0">Opening Hour</th>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input type="text"
                                                                                    class="form-control form-control-solid"
                                                                                    name="contact_openinghour"
                                                                                    value="<?= $details['contact_openinghour'] ?>" />
                                                                            </td>
