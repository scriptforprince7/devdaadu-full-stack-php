...
if (isset($_GET['del'])) {
	...
	if ($query) {
		header('Location:' . BASE_URL . 'manage-home-slider.php');
	}
}
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            ...
                                            <!--begin::Add customer-->
                                            <a href="add-home-slider.php"><button type="button" class="btn btn-primary"
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5"
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="<?= BASE_URL . 'assets/img/' . $row['slider_img'] . '' ?>"
                                                        width="100">
                                                </td>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="<?= BASE_URL ?>edit-home-slider.php?edit_rec=<?= $row['slider_id'] ?>"
                                                                class="menu-link px-3"> Edit </a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="<?= BASE_URL ?>manage-home-slider.php?del=<?= $row['slider_id'] ?>"
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_users_search">Add Slider</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
