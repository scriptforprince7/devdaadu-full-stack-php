...
if (isset($_POST['launch'])) {
	...
	$products_banner_img = $_POST['products_banner_img'];
	$products_bottom_img = $_POST['products_bottom_img'];
	$products_slug = $_POST['products_slug'];
	$products_desc = $_POST['products_desc'];
	$is_active = ($_POST['is_active'] != '' ? 1 : 2);

	if (!empty($_FILES['products_banner_img']['name'])) {
		$products_banner_img = 'img_' . rand(0, 1000) . '_' . $_FILES['products_banner_img']['name'];
	} else {
		$products_banner_img = $_POST['products_img_hidden'];
	}

	if (!empty($_FILES['products_bottom_img']['name'])) {
		$products_bottom_img = 'img_' . rand(0, 1000) . '_' . $_FILES['products_bottom_img']['name'];
	} else {
		$products_bottom_img = $_POST['products_img_hidden'];
	}
	$query = mysqli_query($conn, "update tbl_products
    	                                             ...
    	                                             is_active=$is_active where products_id=$edit_id");

	if ($query) {
		if (!empty($_FILES['products_banner_img']['name'])) {
			move_uploaded_file($_FILES['products_banner_img']['tmp_name'], 'assets/img/' . $products_banner_img . '');
			unlink('assets/img/' . $_POST['products_img_hidden']);
		}
		if (!empty($_FILES['products_bottom_img']['name'])) {
...
$details = mysqli_fetch_array(mysqli_query($conn, "select * from tbl_products where products_id=$edit_id"));
?>
                                                ...
                                                <div class="card card-flush pt-3 mb-5 mb-lg-10">
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-title">
                                                            <h2 class="fw-bolder">Edit Products</h2>
                                                        </div>
                                                            ...
                                                            <div class="table-responsive">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <input type="text"
                                                                                    ...
                                                                                    name="products_name"
                                                                                    value="<?= $details['products_name'] ?>" />
                                                                            </td>
                                                                            <td>
                                                                                <input type="text"
                                                                                    class="form-control form-control-solid"
                                                                                    name="products_slug"
                                                                                    value="<?= $details['products_slug'] ?>" />
                                                                            </td>
                                                                ...
                                                                <table id="kt_create_new_custom_fields"
                                                                    ...
                                                                    <thead>
                                                                        <tr
                                                                            class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                                                            <th class="pt-0">Product Banner Image</th>
                                                                            <th class="pt-0">Product Bottom Image</th>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <input type="file"
                                                                                    class="form-control form-control-solid"
                                                                                    value=""
                                                                                    name="products_banner_img" />
                                                                                <?php if (!empty($details['products_banner_img'])) { ?>
                                                                                <img src="<?= BASE_URL ?>assets/img/<?= $details['products_banner_img'] ?>"
                                                                                    width='50' class="mt-3">
                                                                                <?php } ?>
                                                                                <input type="hidden"
                                                                                    name="products_img_hidden"
                                                                                    value="<?= $details['products_banner_img'] ?>">
                                                                            </td>
                                                                            <td>
                                                                                <input type="file"
                                                                                    class="form-control form-control-solid"
                                                                                    name="products_bottom_img" />
                                                                                <?php if (!empty($details['products_bottom_img'])) { ?>
                                                                                <img src="<?= BASE_URL ?>assets/img/<?= $details['products_bottom_img'] ?>"
                                                                                    width='50' class="mt-3">
                                                                                <?php } ?>
                                                                                <input type="hidden"
                                                                                    name="products_img_hidden"
                                                                                    value="<?= $details['products_bottom_img'] ?>">
                                                                            </td>
                                                                ...
                                                                <table id="kt_create_new_custom_fields"
                                                                    ...
                                                                    <thead>
                                                                        <tr
                                                                            class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                                                            <th class="pt-0">Product Description</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <textarea name="products_desc"
                                                                                    id="default"><?= $details['products_desc'] ?></textarea>
                                                                            </td>
