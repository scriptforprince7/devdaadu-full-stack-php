							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active" href="../../demo8/dist/apps/subscriptions/add.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
						...
						<div class="toolbar">
							...
							<div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
								...
								<div class="page-title d-flex flex-column me-5">
									<!--begin::Title-->
									<h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Subscription Details</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
											...
											<div class="card card-flush pt-3 mb-5 mb-lg-10">
												...
												<div class="card-body pt-0">
													...
													<div class="mb-7 d-none">
														...
														<a href="../../demo8/dist/apps/customers/list.html" class="btn btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_users_search">Add New Customer</a>
													</div>
																	...
																	<div class="flex-equal me-5">
																		<table class="table table-flush fw-bold gy-1">
																			...
																			<tr>
																				...
																				<td class="text-gray-800">**** 3785</td>
																			</tr>
																			<tr>
																...
																<div class="d-flex flex-wrap py-5">
																	...
																	<div class="flex-equal me-5">
																		<table class="table table-flush fw-bold gy-1">
																			...
																			<tr>
																				<td class="text-muted min-w-125px w-125px">Number</td>
																				<td class="text-gray-800">**** 1079</td>
																			</tr>
																			<tr>
																				<td class="text-muted min-w-125px w-125px">Expires</td>
																...
																<div class="d-flex flex-wrap py-5">
																	...
																	<div class="flex-equal me-5">
																		<table class="table table-flush fw-bold gy-1">
																			...
																			<tr>
																				<td class="text-muted min-w-125px w-125px">Number</td>
																				<td class="text-gray-800">**** 2189</td>
																			</tr>
																			<tr>
																				<td class="text-muted min-w-125px w-125px">Expires</td>
											...
											<div class="card-body pt-0 fs-6">
												...
												<div class="mb-7">
													...
													<div class="d-flex align-items-center mb-1">
														<!--begin::Name-->
														<a href="../../demo8/dist/apps/customers/view.html" class="fw-bolder text-gray-800 text-hover-primary me-2">Sean Bean</a>
														<!--end::Name-->
														<!--begin::Status-->
