                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            ...
                                            <!--begin::Add customer-->
                                            <a href="add-services.php"><button type="button" class="btn btn-primary"
                                                    data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add
                                                    New Service</button></a>
                                            <!--end::Add customer-->
                                        </div>
                                        <!--end::Toolbar-->
                                        <!--begin::Group actions-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5"
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="<?= BASE_URL . 'assets/img/' . $row['service_banner_img'] . '' ?>"
                                                        width="100">
                                                </td>

                                                <td>
                                                    <img src="<?= BASE_URL . 'assets/img/' . $row['service_bottom_img'] . '' ?>"
                                                        width="100">
                                                </td>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="<?= BASE_URL ?>edit-services.php?edit_rec=<?= $row['service_id'] ?>"
                                                                class="menu-link px-3"> Edit </a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="<?= BASE_URL ?>manage-services.php?del=<?= $row['service_id'] ?>"
