...
if (isset($_POST['launch'])) {
	...
	$query = mysqli_query($conn, "insert into tbl_testimonials
								...
								<div class="card">
									...
									<div class="card-body pb-0">
										...
										<div class="card-px text-center pt-20 pb-5">
											<!--begin::Title-->
											<h2 class="fs-2x fw-bolder mb-0">Add New Testimonials</h2>
											<!--end::Title-->
											<!--begin::Description-->
											<p class="text-gray-400 fs-4 fw-bold py-7">Click on the below button to launch
												<br />a new testimonial. <a href="manage-testimonials.php"><b>Go back</b></a>
											</p>
											<!--end::Description-->
											<!--begin::Action-->
											<a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">Add New Testimonial</a>
											<!--end::Action-->
										</div>
										<!--end::Heading-->
										<!--begin::Illustration-->
											...
											<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
												...
												<form id="kt_modal" class="form" method="post" enctype="multipart/form-data">
													...
													<div class="mb-13 text-center">
														<!--begin::Title-->
														<h1 class="mb-3">Launch New Testimonial</h1>
														<!--end::Title-->
														<!--begin::Description-->
														<div class="text-muted fw-bold fs-5">To see all testimonials, please
															check
															<a href="manage-testimonials.php" class="fw-bolder link-primary">Manage Testimonials</a>.
														</div>
														<!--end::Description-->
													</div>
													<!--end::Heading-->
													...
													<div class="d-flex flex-column mb-8 fv-row">
														...
														<label class="d-flex align-items-center fs-6 fw-bold mb-2">
															<span class="required">Testimonial Name</span>
															<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a target name for future usage and reference"></i>
														</label>
														<!--end::Label-->
														<input type="text" class="form-control form-control-solid" placeholder="Enter Testimonials Name" name="testimonials_name" />
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
													<div class="d-flex flex-column mb-8">
														<label class="fs-6 fw-bold mb-2">Testimonial Content</label>
														<textarea class="form-control form-control-solid" id="editor" name="testimonials_content" placeholder="Type Testimonial Content"></textarea>
													</div>
													...
													<div class="text-center">
														...
														<button type="submit" name="launch" id="kt_modal" class="btn btn-primary">
															<span class="indicator-label">Add Testimonial</span>
															</span>
														</button>
													</div>
													<!--end::Actions-->
